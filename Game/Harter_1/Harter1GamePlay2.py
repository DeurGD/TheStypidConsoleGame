...
def Var1():
    ...
    print("\n\n        [b dark_khaki]Антон: ", end="")
    print("Завут Антон, рос как обычный малый... Но при факультете все пошло к чертям")
    time.sleep(5)
    clear()
    print("\n\n        [b dark_khaki]Антон: ", end="")
    print("Однокурсник предложил бахнуть соли, ну и я подсел")
    time.sleep(4)
    clear()
    print("\n\n        [b dark_khaki]Антон: ", end="")
    print("Скитался по притонам, поссорился с матерью")
    time.sleep(4)
    clear()
    print("\n\n        [b dark_khaki]Антон: ", end="")
    print("Ну и в конце концов попал в реанимацию, где как сказали врачи 'еще бы секунда и ты бы умер'")
    time.sleep(6)
    clear()
    print("\n\n        [b dark_khaki]Антон: ", end="")
    print("Ну я решил сразу бросить, и вот я сде..")
    time.sleep(3)
    clear()
    print("\n\n        [b dark_khaki]Антон: ", end="")
    print("ТИХО")
    time.sleep(2)
    clear()
    print("\n\n        [b light_pink1]Полиция за дверью: ", end="")
    print("Прапор ты тут смотрел?")
    time.sleep(3)
    clear()
    print("\n\n        [b light_pink1]Полиция за дверью: ", end="")
    print("А что там смотреть это подвал же")
    time.sleep(4)
    clear()
    print("\n\n        [b light_pink1]Полиция за дверью: ", end="")
    print("БЕГОМ ПРОВЕРИТЬ!!! Чтобы через 5 минут там все обрыскал!")
    time.sleep(5)
    clear()
    print("\n\n        [b grey46]Сильный стук по двери, кто то пытается войти", end="")
    time.sleep(5)
    clear()
    print("\n\n        [b light_pink1]Полиция за дверью: ", end="")
    print("Чо за хуйня? Прийдется ломать\n\n\n[bold][light_sky_blue1]    > Ну все нас повяжут..[default]       Антон ЧТО ДЕЛАТЬ?!?")
    ...
    while True:
        ...
        if keyboard.is_pressed('d'):
            ...
            clear()
            print("\n\n        [b light_pink1]Полиция за дверью: ", end="")
            print("Чо за хуйня? Прийдется ломать\n\n\n[bold][default]      Ну все нас пояжут..[light_sky_blue1]     > Антон ЧТО ДЕЛАТЬ?!?")
            Sel = 2
